...
value('tableOfContents', [{
    ...
    'id': 'basics',
    'title': '基础',
    'description': '<p>从这里开始，学习 Go 语言基础。</p><p>声明变量、调用函数，以及进入后续课程前需要了解的内容。</p>',
    'lessons': ['basics', 'flowcontrol', 'moretypes']
}, {
    'id': 'methods',
    'title': '方法和接口',
    'description': '<p>学习如何为类型定义方法、如何声明接口，以及如何把这些概念组合起来。</p>',
    'lessons': ['methods']
}, {
    'id': 'generics',
    'title': '泛型',
    ...
    'id': 'concurrency',
    'title': '并发',
    'description': '<p>Go 将并发特性作为语言核心的一部分提供。</p><p>本模块介绍 goroutine 和信道，以及如何用它们实现不同的并发模式。</p>',
    'lessons': ['concurrency']
}]).
...
value('translation', {
    ...
    'issue-title': 'x/website/_content/tour: [请替换为简短问题描述]',
    'issue-message': '请修改上方标题来描述你的问题，并在这里补充反馈内容；如有需要，请附上代码。',
    'context': '上下文',
}).
